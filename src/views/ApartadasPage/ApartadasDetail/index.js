...
class ApartadasDetail extends Component {
    ...
    onSubmitForm = (data) => {
        ...
        this.props.dispatch(submitConfirmInvestment(data.checked, data.password, this.props.history));
    ...
    render() {
        ...
        const { history, classes, participationDetail, profile_status } = this.props;
        ...
        const { proyecto, orders, listprice, estatus, rendest, qtyinstock } = participationDetail;
        return (
...
const mapStateToProps = ({ participation, auth }) => {
