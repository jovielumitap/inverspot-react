    ...
    render() {
        return (
            <div className="position-relative w-100 h-25">
                ...
                <div className="investment-detail-header-gradient">
                    <div className="investment-detail-header-overview px-2">
