                ...
                <div className="d-flex flex-column p-0 m-0">
                    ...
                    <Swipeable className="d-flex flex-column"
                        ...
                        <div className="tabs-container">
                            ...
                            >
                                <Tab className="tab"
                                     icon={<FontAwesomeIcon className="font-size-18" icon={faInfoCircle}/>}/>
                                <Tab className="tab tab-left-border"
                                     icon={<FontAwesomeIcon className="font-size-18" icon={faClock}/>}/>
                                <Tab className="tab tab-left-border"
                                     icon={<FontAwesomeIcon className="font-size-18" icon={faShoppingCart}/>}/>
                            </Tabs>
                        </div>
                        {value === 0 &&
                            <Tab1/>
